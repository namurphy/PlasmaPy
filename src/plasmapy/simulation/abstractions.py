...
class AbstractNormalizations(ABC):
    ...
    @property
    @abstractmethod
    def current_density(self) -> u.Quantity[u.A / u.m ** 2]:  # ty:ignore[invalid-type-form]
        """The current density normalization."""
        ...

    @property
    @abstractmethod
    def diffusivity(self) -> u.Quantity[u.m ** 2 / u.s]:  # ty:ignore[invalid-type-form]
        """The normalization for diffusivity."""
        ...

    @property
    @abstractmethod
    def dynamic_viscosity(self) -> u.Quantity[u.Pa * u.s]:  # ty:ignore[invalid-type-form]
        """The normalization for dynamic viscosity."""
        ...

    @property
    @abstractmethod
    def electric_field(self) -> u.Quantity[u.V / u.m]:  # ty:ignore[invalid-type-form]
        """The electric field normalization."""
        ...

    @property
    @abstractmethod
    def heat_flux(self) -> u.Quantity[u.J * u.m ** -2 * u.s ** -1]:  # ty:ignore[invalid-type-form]
        """The normalization for heat flux."""
        ...

    @property
    @abstractmethod
    def length(self) -> u.Quantity[u.m]:  # ty:ignore[invalid-type-form]
        """The normalization for length."""
        ...

    @property
    @abstractmethod
    def magnetic_field(self) -> u.Quantity[u.T]:  # ty:ignore[invalid-type-form]
        """The magnetic field normalization."""
        ...

    @property
    @abstractmethod
    def magnetic_flux(self) -> u.Quantity[u.T * u.m]:  # ty:ignore[invalid-type-form]
    ...
    @property
    @abstractmethod
    def mass_density(self) -> u.Quantity[u.kg / u.m ** 3]:  # ty:ignore[invalid-type-form]
    ...
    @property
    @abstractmethod
    def pressure(self) -> u.Quantity[u.Pa]:  # ty:ignore[invalid-type-form]
        """The normalization for pressure."""
        ...

    @property
    @abstractmethod
    def temperature(self) -> u.Quantity[u.K]:  # ty:ignore[invalid-type-form]
        """The normalization for temperature."""
        ...

    @property
    @abstractmethod
    def thermal_conductivity(self) -> u.Quantity[u.W / u.m / u.K]:  # ty:ignore[invalid-type-form]
        """The normalization for thermal conductivity."""
        ...

    @property
    @abstractmethod
    def time(self) -> u.Quantity[u.s]:  # ty:ignore[invalid-type-form]
        """The normalization for time."""
        ...

    @property
    @abstractmethod
    def wavenumber(self) -> u.Quantity[u.m ** -1]:  # ty:ignore[invalid-type-form]
        """The normalization for inverse length."""
        ...

    @property
    @abstractmethod
    def velocity(self) -> u.Quantity[u.m / u.s]:  # ty:ignore[invalid-type-form]
        """The normalization for velocity."""
        ...

    @property
    @abstractmethod
    def volumetric_heating_rate(self) -> u.Quantity[u.J * u.m ** -3 * u.s ** -1]:  # ty:ignore[invalid-type-form]
        """The normalization for the volumetric heating rate."""
        ...

    @property
    @abstractmethod
    def volumetric_rate(self) -> u.Quantity[u.m ** -3 * u.s ** -1]:  # ty:ignore[invalid-type-form]
        """
