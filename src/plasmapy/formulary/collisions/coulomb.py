...
def Coulomb_logarithm(
        ...
        species: (particles.Particle, particles.Particle),  # ty:ignore[invalid-type-form]
    z_mean: float = np.nan,
...
def Coulomb_cross_section(impact_param: u.Quantity[u.m]) -> u.Quantity[u.m ** 2]:  # ty:ignore[invalid-type-form]
    r"""
