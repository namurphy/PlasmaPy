...
def plasma_dispersion_func(
        zeta: complex | np.ndarray | u.Quantity[u.dimensionless_unscaled],  # ty:ignore[invalid-type-form]
) -> complex | np.ndarray | u.Quantity[u.dimensionless_unscaled]:  # ty:ignore[invalid-type-form]
    r"""
